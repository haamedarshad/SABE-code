...
////////////////////////////////////////////////////////////////////////////////////////////////
	public static void enc(String pubfile, String policy, String inputfile) throws Exception {
		BswabePub pub;
		BswabeCph cph;
		BswabeCphKey keyCph;
		byte[] plt;
...
////////////////////////////////////////////////////////////////////////////////////////////////
	public static void dec(String pubfile, String prvfile, String encfile) throws Exception {
		byte[] aesBuf, cphBuf;
		byte[] plt;
		byte[] prv_byte;
		byte[] pub_byte;
		...
		String decfile = encfile.substring(0, encfile.lastIndexOf('.'));
